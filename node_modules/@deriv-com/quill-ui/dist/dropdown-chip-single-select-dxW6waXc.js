...
import P, { useEffect as N, useLayoutEffect as it, useRef as y, useState as V, forwardRef as lt, Fragment as Z, isValidElement as at, cloneElement as ut, createElement as st, useContext as te, createContext as ae, useMemo as M, useReducer as ct, createRef as dt, useCallback as ie } from "react";
import './assets/dropdown-chip-single-select.css';var ft = Object.defineProperty, pt = (e, t, r) => t in e ? ft(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Le = (e, t, r) => (pt(e, typeof t != "symbol" ? t + "" : t, r), r);
let vt = class {
  constructor() {
...
function mt(e, t, r) {
  let [n, o] = V(r), i = e !== void 0, l = y(i), a = y(!1), u = y(!1);
  return i && !l.current && !a.current ? (a.current = !0, l.current = i, console.error("A component is changing from uncontrolled to controlled. This may be caused by the value changing from undefined to a defined value, which should not happen.")) : !i && l.current && !u.current && (u.current = !0, l.current = i, console.error("A component is changing from controlled to uncontrolled. This may be caused by the value changing from a defined value to undefined, which should not happen.")), [i ? e : n, h((s) => (i || o(s), t == null ? void 0 : t(s)))];
}
function bt(e) {
...
function Ne() {
  let e = ht(), [t, r] = le.useState(W.isHandoffComplete);
  return t && W.isHandoffComplete === !1 && r(!1), le.useEffect(() => {
    t !== !0 && r(!0);
  }, [t]), le.useEffect(() => W.handoff(), []), e ? !1 : t;
}
var Ue;
let be = (Ue = P.useId) != null ? Ue : function() {
  let e = Ne(), [t, r] = P.useState(e ? () => W.nextId() : null);
  return D(() => {
    t === null && r(W.nextId());
  }, [t]), t != null ? "" + t : void 0;
};
...
function _e(e, t = 0) {
  var r;
  return e === ((r = Ge(e)) == null ? void 0 : r.body) ? !1 : R(t, { 0() {
    return e.matches(Be);
  }, 1() {
    let n = e;
    for (; n !== null; ) {
...
function Pt(e, t, r = !0) {
  ...
  function o(l, a) {
    if (!n.current || l.defaultPrevented) return;
    let u = a(l);
  ...
  fe("pointerdown", (l) => {
    var a, u;
    n.current && (i.current = ((u = (a = l.composedPath) == null ? void 0 : a.call(l)) == null ? void 0 : u[0]) || l.target);
  }, !0), fe("mousedown", (l) => {
    var a, u;
    n.current && (i.current = ((u = (a = l.composedPath) == null ? void 0 : a.call(l)) == null ? void 0 : u[0]) || l.target);
  }, !0), fe("click", (l) => {
...
function z(...e) {
  ...
  return e.every((n) => n == null || (n == null ? void 0 : n[$t])) ? void 0 : r;
}
function Ve(e) {
...
function K({ ourProps: e, theirProps: t, slot: r, defaultTag: n, features: o, visible: i = !0, name: l, mergeRefs: a }) {
  a = a ?? It;
  let u = Ye(t, e);
  if (i) return pe(u, r, n, l, a);
  let s = o ?? 0;
  if (s & 2) {
    let { static: c = !1, ...v } = u;
    if (c) return pe(v, r, n, l, a);
  }
  if (s & 1) {
    let { unmount: c = !0, ...v } = u;
    return R(c ? 0 : 1, { 0() {
      ...
      return pe({ ...v, hidden: !0, style: { display: "none" } }, r, n, l, a);
    } });
  }
  return pe(u, r, n, l, a);
}
function pe(e, t = {}, r, n, o) {
  let { as: i = r, children: l, refName: a = "ref", ...u } = Te(e, ["unmount", "static"]), s = e.ref !== void 0 ? { [a]: e.ref } : {}, c = typeof l == "function" ? l(t) : l;
  ...
  if (i === Z && Object.keys(Fe(u)).length > 0) {
    if (!at(c) || Array.isArray(c) && c.length > 1) throw new Error(['Passing props on "Fragment"!', "", `The current component <${n} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(u).map((m) => `  - ${m}`).join(`
...
function Dt(e, t) {
  var r;
  let { features: n = 1, ...o } = e, i = { ref: t, "aria-hidden": (n & 2) === 2 ? !0 : (r = o["aria-hidden"]) != null ? r : void 0, style: { position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0", ...(n & 4) === 4 && (n & 2) !== 2 && { display: "none" } } };
...
function Ht(e, t) {
  ...
  let n = t.resolveActiveIndex(), o = n ?? -1;
  switch (e.focus) {
    case 0: {
      for (let i = 0; i < r.length; ++i) if (!t.resolveDisabled(r[i], i, r)) return i;
      return n;
    }
    case 1: {
      for (let i = o - 1; i >= 0; --i) if (!t.resolveDisabled(r[i], i, r)) return i;
      return n;
    }
    case 2: {
      for (let i = o + 1; i < r.length; ++i) if (!t.resolveDisabled(r[i], i, r)) return i;
      return n;
    }
    case 3: {
      for (let i = r.length - 1; i >= 0; --i) if (!t.resolveDisabled(r[i], i, r)) return i;
      return n;
    }
    case 4: {
      for (let i = 0; i < r.length; ++i) if (t.resolveId(r[i], i, r) === e.id) return i;
      return n;
    }
    case 5:
      return null;
...
function Ze(e = {}, t = null, r = []) {
  for (let [n, o] of Object.entries(e)) tt(r, et(t, n), o);
  return r;
}
function et(e, t) {
  return e ? e + "[" + t + "]" : t;
...
function tt(e, t, r) {
  if (Array.isArray(r)) for (let [n, o] of r.entries()) tt(e, et(t, n.toString()), o);
  else r instanceof Date ? e.push([t, r.toISOString()]) : typeof r == "boolean" ? e.push([t, r ? "1" : "0"]) : typeof r == "string" ? e.push([t, r]) : typeof r == "number" ? e.push([t, `${r}`]) : r == null ? e.push([t, ""]) : Ze(r, t, e);
}
...
function Pe(e, t = (r) => r) {
  let r = e.activeOptionIndex !== null ? e.options[e.activeOptionIndex] : null, n = wt(t(e.options.slice()), (i) => i.dataRef.current.domRef.current), o = r ? n.indexOf(r) : null;
  return o === -1 && (o = null), { options: n, activeOptionIndex: o };
}
let Kt = { 1(e) {
  return e.dataRef.current.disabled || e.listboxState === 1 ? e : { ...e, activeOptionIndex: null, listboxState: 1 };
}, 0(e) {
  if (e.dataRef.current.disabled || e.listboxState === 0) return e;
  let t = e.activeOptionIndex, { isSelected: r } = e.dataRef.current, n = e.options.findIndex((o) => r(o.dataRef.current.value));
  return n !== -1 && (t = n), { ...e, listboxState: 0, activeOptionIndex: t };
}, 2(e, t) {
  var r;
  if (e.dataRef.current.disabled || e.listboxState === 1) return e;
  let n = Pe(e), o = Ht(t, { resolveItems: () => n.options, resolveActiveIndex: () => n.activeOptionIndex, resolveId: (i) => i.id, resolveDisabled: (i) => i.dataRef.current.disabled });
  return { ...e, ...n, searchQuery: "", activeOptionIndex: o, activationTrigger: (r = t.trigger) != null ? r : 1 };
}, 3: (e, t) => {
  if (e.dataRef.current.disabled || e.listboxState === 1) return e;
  let r = e.searchQuery !== "" ? 0 : 1, n = e.searchQuery + t.value.toLowerCase(), o = (e.activeOptionIndex !== null ? e.options.slice(e.activeOptionIndex + r).concat(e.options.slice(0, e.activeOptionIndex + r)) : e.options).find((l) => {
    var a;
    return !l.dataRef.current.disabled && ((a = l.dataRef.current.textValue) == null ? void 0 : a.startsWith(n));
  ...
  let r = { id: t.id, dataRef: t.dataRef }, n = Pe(e, (o) => [...o, r]);
...
let zt = Z;
function Gt(e, t) {
  let { value: r, defaultValue: n, form: o, name: i, onChange: l, by: a = (b, w) => b === w, disabled: u = !1, horizontal: s = !1, multiple: c = !1, ...v } = e;
  const x = s ? "horizontal" : "vertical";
  let g = z(t), [p = c ? [] : void 0, m] = mt(r, l, n), [f, d] = ct(Wt, { dataRef: dt(), listboxState: 1, options: [], searchQuery: "", labelId: null, activeOptionIndex: null, activationTrigger: 1 }), O = y({ static: !1, hold: !1 }), L = y(null), A = y(null), G = y(null), S = h(typeof a == "string" ? (b, w) => {
    let $ = a;
  ...
  }), X = h(() => d({ type: 0 })), ne = h(() => d({ type: 1 })), ye = h((b, w, $) => b === F.Specific ? d({ type: 2, focus: F.Specific, id: w, trigger: $ }) : d({ type: 2, focus: b, trigger: $ })), ce = h((b, w) => (d({ type: 5, id: b, dataRef: w }), () => d({ type: 6, id: b }))), Oe = h((b) => (d({ type: 7, id: b }), () => d({ type: 7, id: null }))), H = h((b) => R(E.mode, { 0() {
    return m == null ? void 0 : m(b);
  }, 1() {
    let w = E.value.slice(), $ = w.findIndex((de) => S(de, b));
    return $ === -1 ? w.push(b) : w.splice($, 1), m == null ? void 0 : m(w);
  } })), we = h((b) => d({ type: 3, value: b })), Se = h(() => d({ type: 4 })), J = M(() => ({ onChange: H, registerOption: ce, registerLabel: Oe, goToOption: ye, closeListbox: ne, openListbox: X, selectActiveOption: re, selectOption: Y, search: we, clearSearch: Se }), []), oe = { ref: g }, k = y(null), Ee = ee();
  return N(() => {
    k.current && n !== void 0 && Ee.addEventListener(k.current, "reset", () => {
      m == null || m(n);
    });
...
function Yt(e, t) {
  var r;
  let n = be(), { id: o = `headlessui-listbox-button-${n}`, ...i } = e, l = se("Listbox.Button"), a = ue("Listbox.Button"), u = z(l.buttonRef, t), s = ee(), c = h((f) => {
    switch (f.key) {
      case T.Space:
      case T.Enter:
      case T.ArrowDown:
  ...
  }, [l.labelId, o]), p = M(() => ({ open: l.listboxState === 0, disabled: l.disabled, value: l.value }), [l]), m = { ref: u, id: o, type: Rt(e, l.buttonRef), "aria-haspopup": "listbox", "aria-controls": (r = l.optionsRef.current) == null ? void 0 : r.id, "aria-expanded": l.listboxState === 0, "aria-labelledby": g, disabled: l.disabled, onKeyDown: c, onKeyUp: v, onClick: x };
  return K({ ourProps: m, theirProps: i, slot: p, defaultTag: _t, name: "Listbox.Button" });
}
let Xt = "label";
function Jt(e, t) {
  let r = be(), { id: n = `headlessui-listbox-label-${r}`, ...o } = e, i = se("Listbox.Label"), l = ue("Listbox.Label"), a = z(i.labelRef, t);
  D(() => l.registerLabel(n), [n]);
  let u = h(() => {
    var c;
    return (c = i.buttonRef.current) == null ? void 0 : c.focus({ preventScroll: !0 });
  }), s = M(() => ({ open: i.listboxState === 0, disabled: i.disabled }), [i]);
  return K({ ourProps: { ref: a, id: n, onClick: u }, theirProps: o, slot: s, defaultTag: Xt, name: "Listbox.Label" });
}
let Zt = "ul", er = me.RenderStrategy | me.Static;
function tr(e, t) {
  var r;
  let n = be(), { id: o = `headlessui-listbox-options-${n}`, ...i } = e, l = se("Listbox.Options"), a = ue("Listbox.Options"), u = z(l.optionsRef, t), s = ee(), c = ee(), v = Ce(), x = v !== null ? (v & I.Open) === I.Open : l.listboxState === 0;
  N(() => {
    var d;
  ...
  }, [l.buttonRef.current]), m = M(() => ({ open: l.listboxState === 0 }), [l]), f = { "aria-activedescendant": l.activeOptionIndex === null || (r = l.options[l.activeOptionIndex]) == null ? void 0 : r.id, "aria-multiselectable": l.mode === 1 ? !0 : void 0, "aria-labelledby": p, "aria-orientation": l.orientation, id: o, onKeyDown: g, role: "listbox", tabIndex: 0, ref: u };
  return K({ ourProps: f, theirProps: i, slot: m, defaultTag: Zt, features: er, visible: x, name: "Listbox.Options" });
}
let rr = "li";
function nr(e, t) {
  let r = be(), { id: n = `headlessui-listbox-option-${r}`, disabled: o = !1, value: i, ...l } = e, a = se("Listbox.Option"), u = ue("Listbox.Option"), s = a.activeOptionIndex !== null ? a.options[a.activeOptionIndex].id === n : !1, c = a.isSelected(i), v = y(null), x = Ut(v), g = j({ disabled: o, value: i, domRef: v, get textValue() {
    return x();
  } }), p = z(t, v);
  D(() => {
  ...
  }, [v, s, a.listboxState, a.activationTrigger, a.activeOptionIndex]), D(() => u.registerOption(n, g), [g, n]);
  let m = h((S) => {
    ...
    u.goToOption(F.Specific, n);
  }), d = Ft(), O = h((S) => d.update(S)), L = h((S) => {
    d.wasMoved(S) && (o || s || u.goToOption(F.Specific, n, 0));
  }), A = h((S) => {
    d.wasMoved(S) && (o || s && u.goToOption(F.Nothing));
  }), G = M(() => ({ active: s, selected: c, disabled: o }), [s, c, o]);
  return K({ ourProps: { id: n, ref: p, role: "option", tabIndex: o === !0 ? void 0 : -1, "aria-disabled": o === !0 ? !0 : void 0, "aria-selected": c, disabled: void 0, onClick: m, onFocus: f, onPointerEnter: O, onMouseEnter: O, onPointerMove: L, onMouseMove: L, onPointerLeave: A, onMouseLeave: A }, theirProps: l, slot: G, defaultTag: rr, name: "Listbox.Option" });
}
let or = U(Gt), ir = U(Yt), lr = U(Jt), ar = U(tr), ur = U(nr), Pr = Object.assign(or, { Button: ir, Label: lr, Options: ar, Option: ur });
function sr(e = 0) {
  let [t, r] = V(e), n = ke(), o = ie((u) => {
    n.current && r((s) => s | u);
  }, [t, n]), i = ie((u) => !!(t & u), [t]), l = ie((u) => {
    n.current && r((s) => s & ~u);
  }, [r, n]), a = ie((u) => {
    n.current && r((s) => s ^ u);
  }, [r]);
...
function dr(e, t) {
  ...
  let { transitionDuration: n, transitionDelay: o } = getComputedStyle(e), [i, l] = [n, o].map((u) => {
...
function fr(e, t, r, n) {
  let o = r ? "enter" : "leave", i = Q(), l = n !== void 0 ? cr(n) : () => {
  };
  ...
  return $e(e, ...t.base, ...t.enter, ...t.enterTo, ...t.enterFrom, ...t.leave, ...t.leaveFrom, ...t.leaveTo, ...t.entered), Re(e, ...t.base, ...a, ...s), i.nextFrame(() => {
    $e(e, ...t.base, ...a, ...s), Re(e, ...t.base, ...a, ...u), dr(e, () => ($e(e, ...t.base, ...a), Re(e, ...t.base, ...t.entered), l()));
  }), i.dispose;
}
function pr({ immediate: e, container: t, direction: r, classes: n, onStart: o, onStop: i }) {
  let l = ke(), a = ee(), u = j(r);
  D(() => {
    e && (u.current = "enter");
  }, [e]), D(() => {
    ...
    a.add(s.dispose);
    let c = t.current;
    if (c && u.current !== "idle" && l.current) return s.dispose(), o.current(u.current), s.add(fr(c, n.current, u.current === "enter", () => {
...
function rt(e, t) {
  let r = j(e), n = y([]), o = ke(), i = ee(), l = h((g, p = q.Hidden) => {
    let m = n.current.findIndex(({ el: f }) => f === g);
    m !== -1 && (R(p, { [q.Unmount]() {
      ...
      var f;
      !xe(n) && o.current && ((f = r.current) == null || f.call(r));
    }));
  }), a = h((g) => {
    let p = n.current.find(({ el: m }) => m === g);
    return p ? p.state !== "visible" && (p.state = "visible") : n.current.push({ el: g, state: "visible" }), () => l(g, q.Unmount);
  ...
  return M(() => ({ children: n, register: a, unregister: l, onStart: v, onStop: x, wait: s, chains: c }), [a, l, n, v, x, c, s]);
}
function hr() {
}
let gr = ["beforeEnter", "afterEnter", "beforeLeave", "afterLeave"];
function We(e) {
  var t;
  let r = {};
  for (let n of gr) r[n] = (t = e[n]) != null ? t : hr;
  return r;
}
function xr(e) {
  let t = y(We(e));
...
let yr = "div", nt = me.RenderStrategy;
function Or(e, t) {
  var r, n;
  let { beforeEnter: o, afterEnter: i, beforeLeave: l, afterLeave: a, enter: u, enterFrom: s, enterTo: c, entered: v, leave: x, leaveFrom: g, leaveTo: p, ...m } = e, f = y(null), d = z(f, t), O = (r = m.unmount) == null || r ? q.Unmount : q.Hidden, { show: L, appear: A, initial: G } = mr(), [S, C] = V(L ? "visible" : "hidden"), E = br(), { register: _, unregister: Y } = E;
  N(() => _(f), [_, f]), N(() => {
  ...
  let re = j({ base: B(m.className), enter: B(u), enterFrom: B(s), enterTo: B(c), entered: B(v), leave: B(x), leaveFrom: B(g), leaveTo: B(p) }), X = xr({ beforeEnter: o, afterEnter: i, beforeLeave: l, afterLeave: a }), ne = Ne();
  N(() => {
    if (ne && S === "visible" && f.current === null) throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [f, S, ne]);
  let ye = G && !A, ce = A && L && G, Oe = !ne || ye ? "idle" : L ? "enter" : "leave", H = sr(0), we = h((b) => R(b, { enter: () => {
  ...
  pr({ immediate: ce, container: f, classes: re, direction: Oe, onStart: j((b) => {
    oe.current = !0, J.onStart(f, b, we);
  }), onStop: j((b) => {
    oe.current = !1, J.onStop(f, b, Se), b === "leave" && !xe(J) && (C("hidden"), Y(f));
  }) });
  let k = m, Ee = { ref: d };
  return ce ? k = { ...k, className: ve(m.className, ...re.current.enter, ...re.current.enterFrom) } : oe.current && (k.className = ve(m.className, (n = f.current) == null ? void 0 : n.className), k.className === "" && delete k.className), P.createElement(ge.Provider, { value: J }, P.createElement(Je, { value: R(S, { visible: I.Open, hidden: I.Closed }) | H.flags }, K({ ourProps: Ee, theirProps: k, defaultTag: yr, features: nt, visible: S === "visible", name: "Transition.Child" })));
}
function wr(e, t) {
  let { show: r, appear: n = !1, unmount: o = !0, ...i } = e, l = y(null), a = z(l, t);
  Ne();
  let u = Ce();
  if (r === void 0 && u !== null && (r = (u & I.Open) === I.Open), ![!0, !1].includes(r)) throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
  let [s, c] = V(r ? "visible" : "hidden"), v = rt(() => {
    c("hidden");
  }), [x, g] = V(!0), p = y([r]);
  D(() => {
    x !== !1 && p.current[p.current.length - 1] !== r && (p.current.push(r), g(!1));
  }, [p, r]);
  let m = M(() => ({ show: r, appear: n, initial: x }), [r, n, x]);
  N(() => {
    if (r) c("visible");
  ...
  return P.createElement(ge.Provider, { value: v }, P.createElement(he.Provider, { value: m }, K({ ourProps: { ...f, as: Z, children: P.createElement(ot, { ref: a, ...f, ...i, beforeEnter: d, beforeLeave: O }) }, theirProps: {}, defaultTag: Z, features: nt, visible: s === "visible", name: "Transition" })));
}
function Sr(e, t) {
  let r = te(he) !== null, n = Ce() !== null;
  return P.createElement(P.Fragment, null, !r && n ? P.createElement(Ie, { ref: t, ...e }) : P.createElement(ot, { ref: t, ...e }));
}
let Ie = U(wr), ot = U(Or), Er = U(Sr), Rr = Object.assign(Ie, { Child: Er, Root: Ie });
export {
  Pr as I,
  Rr as q
};
