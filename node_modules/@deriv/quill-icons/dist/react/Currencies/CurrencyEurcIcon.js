...
export const CurrencyEurcIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("g", { clipPath: 'url(#a976e588a)' },
        React.createElement("circle", { cx: 16, cy: 16, r: 16, fill: '#2775CA' }),
        React.createElement("path", { fill: '#fff', d: 'm18.445 14.044-.607 1.317H9.433l.479-1.317zm-1.144 2.595-.62 1.33H9.433l.479-1.33zm2.704-6.066-.754 1.617a5.5 5.5 0 0 0-.78-.556 4 4 0 0 0-.908-.396 3.4 3.4 0 0 0-1.042-.153q-1.022 0-1.821.55-.8.549-1.26 1.648-.453 1.095-.453 2.723 0 1.63.453 2.723.46 1.095 1.26 1.643.799.543 1.821.544.563 0 1.049-.148.492-.146.895-.383.408-.243.735-.511l.773 1.61q-.678.614-1.572.927a5.7 5.7 0 0 1-1.88.313q-1.604 0-2.844-.811-1.233-.812-1.937-2.314-.703-1.509-.703-3.593 0-2.09.703-3.598.703-1.51 1.937-2.32 1.24-.812 2.844-.812 1.023 0 1.905.338a5 5 0 0 1 1.58.96' }),
    ...
    React.createElement("defs", null,
        React.createElement("clipPath", { id: 'a976e588a' },
