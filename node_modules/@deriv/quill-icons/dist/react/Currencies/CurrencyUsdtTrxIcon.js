...
export const CurrencyUsdtTrxIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    title ? React.createElement("title", { id: titleId }, title) : null,
    React.createElement("path", { fill: '#DC062B', d: 'M22 25a6 6 0 1 1-12 0 6 6 0 0 1 12 0' }),
    React.createElement("path", { fill: '#fff', d: 'M17.678 22.834 13.145 22l2.385 6 3.323-4.048zm-.073.367.693.659-1.896.343zm-1.615.934-1.998-1.658 3.266.601zm-.142.293-.326 2.693-1.756-4.42zm.301.143 2.1-.38-2.408 2.933z' }),
