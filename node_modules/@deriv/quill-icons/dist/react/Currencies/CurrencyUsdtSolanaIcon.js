...
export const CurrencyUsdtSolanaIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 32 32', ...sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    ...
    React.createElement("path", { fill: 'url(#e83f5028a)', d: 'M13.722 22.42a.23.23 0 0 1 .156-.065h5.386a.11.11 0 0 1 .078.189l-1.064 1.064a.22.22 0 0 1-.156.064h-5.386a.11.11 0 0 1-.079-.188z' }),
    React.createElement("path", { fill: 'url(#e83f5028b)', d: 'M13.722 26.393a.22.22 0 0 1 .156-.065h5.386a.11.11 0 0 1 .078.189l-1.064 1.064a.22.22 0 0 1-.156.064h-5.386a.11.11 0 0 1-.079-.188z' }),
    React.createElement("path", { fill: 'url(#e83f5028c)', d: 'M18.122 24.329a.22.22 0 0 1 .156.064l1.064 1.065a.11.11 0 0 1-.078.188h-5.386a.22.22 0 0 1-.156-.065l-1.064-1.064a.11.11 0 0 1 .078-.188z' }),
    React.createElement("defs", null,
        React.createElement("linearGradient", { id: 'e83f5028a', x1: 17.93, x2: 14.201, y1: 21.291, y2: 28.432, gradientUnits: 'userSpaceOnUse' },
            React.createElement("stop", { stopColor: '#00FFA3' }),
            React.createElement("stop", { offset: 1, stopColor: '#DC1FFF' })),
        React.createElement("linearGradient", { id: 'e83f5028b', x1: 17.93, x2: 14.201, y1: 21.291, y2: 28.432, gradientUnits: 'userSpaceOnUse' },
            React.createElement("stop", { stopColor: '#00FFA3' }),
            React.createElement("stop", { offset: 1, stopColor: '#DC1FFF' })),
        React.createElement("linearGradient", { id: 'e83f5028c', x1: 17.93, x2: 14.201, y1: 21.291, y2: 28.432, gradientUnits: 'userSpaceOnUse' },
            React.createElement("stop", { stopColor: '#00FFA3' }),
            React.createElement("stop", { offset: 1, stopColor: '#DC1FFF' })))));
