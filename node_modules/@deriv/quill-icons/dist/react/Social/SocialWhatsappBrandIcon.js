...
export const SocialWhatsappBrandIcon = ({ iconSize = 'md', title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 40 40', ...sizes[iconSize], role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    ...
    React.createElement("defs", null,
        React.createElement("linearGradient", { id: '369015eab', x1: 20, x2: 20, y1: 34.664, y2: 2.665, gradientUnits: 'userSpaceOnUse' },
            React.createElement("stop", { stopColor: '#20B038' }),
            React.createElement("stop", { offset: 1, stopColor: '#60D66A' })),
        React.createElement("linearGradient", { id: '369015eac', x1: 20, x2: 20, y1: 34.8, y2: 2.658, gradientUnits: 'userSpaceOnUse' },
            React.createElement("stop", { stopColor: '#F9F9F9' }),
            React.createElement("stop", { offset: 1, stopColor: '#fff' })),
        React.createElement("filter", { id: '369015eaa', width: 40, height: 40, x: 0, y: 0, colorInterpolationFilters: 'sRGB', filterUnits: 'userSpaceOnUse' },
