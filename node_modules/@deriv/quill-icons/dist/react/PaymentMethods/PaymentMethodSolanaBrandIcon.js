...
const PaymentMethodSolanaBrandIcon = ({ title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 128 80', role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    ...
    React.createElement("path", { fill: 'url(#ed735a56b)', d: 'm23.897 45.16-3.302 3.54a.76.76 0 0 1-.56.244H4.385a.384.384 0 0 1-.282-.645L7.4 44.76a.76.76 0 0 1 .56-.244h15.652a.381.381 0 0 1 .285.645m-3.302-7.131a.77.77 0 0 0-.56-.244H4.385a.384.384 0 0 0-.282.644L7.4 41.971a.77.77 0 0 0 .56.245h15.652a.384.384 0 0 0 .28-.645zM4.384 35.485h15.652a.76.76 0 0 0 .559-.244l3.302-3.54a.382.382 0 0 0-.285-.645H7.959a.76.76 0 0 0-.559.244l-3.298 3.54a.383.383 0 0 0 .282.645' }),
    React.createElement("defs", null,
        React.createElement("linearGradient", { id: 'ed735a56a', x1: 5.688, x2: 22.1, y1: 49.371, y2: 30.868, gradientUnits: 'userSpaceOnUse' },
        ...
        React.createElement("linearGradient", { id: 'ed735a56b', x1: 5.688, x2: 22.1, y1: 49.371, y2: 30.868, gradientUnits: 'userSpaceOnUse' },
            React.createElement("stop", { offset: 0.08, stopColor: '#9945FF' }),
            React.createElement("stop", { offset: 0.3, stopColor: '#8752F3' }),
            React.createElement("stop", { offset: 0.5, stopColor: '#5497D5' }),
            React.createElement("stop", { offset: 0.6, stopColor: '#43B4CA' }),
