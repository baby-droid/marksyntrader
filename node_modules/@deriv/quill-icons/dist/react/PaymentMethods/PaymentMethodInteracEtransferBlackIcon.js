...
const PaymentMethodInteracEtransferBlackIcon = ({ title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 128 80', role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    ...
    React.createElement("g", { fill: '#000' },
        React.createElement("path", { d: 'M26.42 34.434c-.765.173-1.166.919-1.172 2.163l2.312-.554v-.374c-.01-.925-.3-1.427-1.14-1.235m13.73-.198s-.449.335-1.155.677c-.717.355-1.043.785-1.043 1.456 0 .583.352.964 1.01.801.7-.172 1.189-.83 1.189-1.739-.008-.39-.004-.78-.002-1.017l.001-.088zm7.716-10.324c.306 0 .479-.183.479-.489 0-.316-.134-.488-.45-.488h-.403v.967h.374z' }),
