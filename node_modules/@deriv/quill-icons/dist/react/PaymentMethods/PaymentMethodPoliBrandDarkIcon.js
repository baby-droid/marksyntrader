...
const PaymentMethodPoliBrandDarkIcon = ({ title, titleId, ...props }, ref) => (React.createElement("svg", { xmlns: 'http://www.w3.org/2000/svg', fill: 'none', viewBox: '0 0 128 80', role: 'img', ref: ref, "aria-labelledby": titleId, ...props },
    ...
    React.createElement("g", { fillRule: 'evenodd', clipRule: 'evenodd' },
        ...
        React.createElement("path", { fill: '#fff', d: 'M17.476 29.2a10.837 10.837 0 0 0 .007 20.745l-.01-20.75zm3.121-.46q-.376 0-.748.03v1.11a6.74 6.74 0 0 1 7.326 6.45 6.74 6.74 0 0 1-6.796 7.009V50.4h.228a10.83 10.83 0 0 0-.01-21.66m26.32 27.531V23.73h1.627v32.54z' }))));
