...
The visible chart rail must scope native-control lookups to its closest `.dashboard__chart-wrapper`, not query the document globally. Four fixed-size settings buttons sit lower-left, native navigation stays bottom-center, and dialogs open as compact panels beside the rail.
