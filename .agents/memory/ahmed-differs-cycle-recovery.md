...
**How to apply:** Keep the executable XML copies synchronized and validate that the recovery branch is guarded by both the waiting state and a streak of at least three.