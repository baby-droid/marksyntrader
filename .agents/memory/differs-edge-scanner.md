...
**How to apply:** Keep the XML loadable through both Free Bots and Bot Builder. A win resets stake and advances the main rotation; a loss multiplies stake by 2, stores the next main phase, and sets recovery phase 6 for an even scanned digit or 7 for an odd scanned digit. Recovery losses remain in parity recovery; a recovery win resumes the stored next phase.
