...
**How to apply:** Keep the pathname detection aligned with `PREVIEW_BASE_PATH`; production static builds still use the environment flag and standalone root deployments remain outside preview mode.